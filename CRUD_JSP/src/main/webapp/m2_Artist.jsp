...
<%
jb.connect();
int aux = java.lang.Integer.parseInt(request.getParameter("idArtist"));
String Nume = request.getParameter("Nume");
String Prenume = request.getParameter("Prenume");
String Instrument = request.getParameter("Instrument");
String NumeImpresar = request.getParameter("NumeImpresar");
String[] valori = {Nume, Prenume, Instrument, NumeImpresar};
String[] campuri = {"Nume", "Prenume", "Instrument","NumeImpresar"};
jb.modificaTabela("artisti", "idArtist", aux, campuri, valori);
jb.disconnect();
%>
