...
<br/>
<p align="center"><a href="nou_Concert.jsp"><b class="buton2">Adauga un nou concert</b></a></p>
<%
jb.connect();
int aux = java.lang.Integer.parseInt(request.getParameter("idConcert"));
String Nume = request.getParameter("Denumire");
String Prenume = request.getParameter("Locatie");
String Sectie = request.getParameter("GenMuzical");
