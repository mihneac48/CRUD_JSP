...
%>
<h1 class="titlu"> Suntem in tabela Artist.</h1>
<form action="nou_Artist.jsp" method="post">
<table>
<tr>
<td class="text" align="right">Nume Artist:</td>
<td> <input type="text" name="Nume" size="40" /></td>
</tr>
<tr>
<td class="text" align="right">Prenume Artist:</td>
<td> <input type="text" name="Prenume" size="30" /></td>
</tr>
<tr>
<td class="text" align="right">Instrument:</td>
<td> <input type="text" name="Instrument" size="30" /></td>
<tr>
<td class="text" align="right">Nume Impresar:</td>
<td> <input type="text" name="NumeImpresar" size="30" /></td>
</tr>
</table>
