...
public class JavaBean {
	...
	public void connect() throws ClassNotFoundException, SQLException, Exception {
		try {
			...
			con = DriverManager.getConnection("jdbc:mysql://localhost:3306/muzica?useSSL=false",
					"root", "123401234");
	...
	public void adaugaArtist(String Nume, String Prenume, String Instrument, String NumeImpresar )
		...
		if (con != null) {
			try {
				...
				stmt.executeUpdate("insert into artisti(Nume, Prenume, Instrument, NumeImpresar) values('" + Nume
						+ "' , '" + Prenume + "', '" + Instrument + "', '" + NumeImpresar + "');");
			} catch (SQLException sqle) {
	...
	public void adaugaConcert(String Denumire, String Locatie, String GenMuzical)
			throws SQLException, Exception {
		if (con != null) {
			try {
				// creaza un "prepared SQL statement"
				Statement stmt;
				stmt = con.createStatement();
				stmt.executeUpdate("insert into concerte(Denumire, Locatie, GenMuzical) values('" + Denumire +
						"' , '" + Locatie + "', '" + GenMuzical + "');");
			} catch (SQLException sqle) {
				error = "ExceptieSQL: Reactualizare nereusita; este posibil sa existe duplicate.";
				throw new SQLException(error);
	...
	public void adaugaRepartizare(int idArtist, int idConcert)
		...
		if (con != null) {
			try {
				...
				Statement stmt;
				stmt = con.createStatement();
				stmt.executeUpdate("insert into repartizari(idArtist, idConcert) values('" + idArtist + "' , '" + idConcert + "');");
			} catch (SQLException sqle) {
				error = "ExceptieSQL: Reactualizare nereusita; este posibil sa existe duplicate.";
				throw new SQLException(error);
			}
